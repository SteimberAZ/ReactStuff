  ...
  return (
    <button
      ...
      className={`flex flex-row items-center justify-center p-2 hover:bg-blue-700 text-white bg-blue-500 rounded-sm m-1 cursor-pointer w-[120px] ${
        open ? "hover:bg-gray-600  bg-gray-400 cursor-progress " : ""
      }`}
      onClick={() => {
       setOpen(!open);
     }} //ya me lo ahorro con diable
    >
      <svg
      ...
      <svg
        className={`w-5 h-5 animate-spin ${open ? "block" : "hidden"} `}
        viewBox="0 0 24 24"
        fill="#000000"
        xmlns="http://www.w3.org/2000/svg"
      >
